...
class _ProfilePageState extends State<ProfilePage> {
  ...
  Future<void> _fetchUserData() async {
    ...
    setState(() {
      ...
      _hospitalNameController.text = _user!.hospitalName ?? '';
      _phoneNumberController.text = _user!.phoneNumber ?? '';
      _addressController.text = _user!.address ?? '';
      _doctorIdController.text = _user!.doctorId ?? '';
      _doctorNameController.text = _user!.doctorName ?? '';
  ...
  Future<void> _saveForm() async {
    if (_formKey.currentState!.validate()) {
      ...
      if (_user != null) {
        // _user!.id = _idController.text;
        // _user!.email = _emailController.text;
        _user!.hospitalName = _hospitalNameController.text;
        _user!.phoneNumber = _phoneNumberController.text;
        _user!.address = _addressController.text;
        _user!.doctorId = _doctorIdController.text;
        _user!.doctorName = _doctorNameController.text;
