...
//   success &= await health.writeHealthData(55, HealthDataType.HEART_RATE, earlier, now);
//   success &= await health.writeHealthData(37, HealthDataType.BODY_TEMPERATURE, earlier, now);
//   success &= await health.writeBloodOxygen(90, earlier, now, flowRate: 1.0);
...
//   success &= await health.writeWorkoutData(HealthWorkoutActivityType.AMERICAN_FOOTBALL, now.subtract(Duration(minutes: 15)), now, totalDistance: 2430, totalEnergyBurned: 400);
...
//
//   success &= await health.writeMeal(earlier, now, 1000, 50, 25, 50, "Banana", MealType.SNACK);
//   // Store an Audiogram
